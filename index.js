...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.addEventListener("click", function (event) {
        if (sidebar.style.width === "250px" && !sidebar.contains(event.target) && !toggleBtn.contains(event.target)) {
    ...
    if (searchInputField) {
        searchInputField.addEventListener("input", filterCourseCards);
    }

    // Gestion de l'affichage de l'image de profil en grand
